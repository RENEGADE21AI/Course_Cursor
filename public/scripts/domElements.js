...
const clanssButton = document.getElementById('clanssButton');
const clanssOverlay = document.getElementById('clanssOverlay');
const closeclanss = document.getElementById('closeclanss');
